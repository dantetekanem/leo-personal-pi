...
| 2 | database-engineer | [skills/database-engineer](./skills/database-engineer) | Database schema, SQL correctness, query plans, indexing, constraints, transactions, migrations, integrity, and performance. |
| 3 | frontend-animator | [skills/frontend-animator](./skills/frontend-animator) | Frontend motion design, animations, transitions, micro-interactions, scroll effects, and performance-sensitive UI motion. |
